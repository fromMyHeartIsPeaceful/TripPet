...
struct AchievementEngine {
    ...
    static let stepTiers: [AchievementTier] = [
        AchievementTier(category: .steps, threshold: 3_000, title: "您也是辛苦了", subtitle: nil),
        AchievementTier(category: .steps, threshold: 9_000, title: "没病走两步", subtitle: nil),
        AchievementTier(category: .steps, threshold: 20_000, title: "佛山无影脚在世传人", subtitle: nil),
        AchievementTier(category: .steps, threshold: 30_000, title: "要啥自行车", subtitle: nil),
        AchievementTier(category: .steps, threshold: 50_000, title: "有了闪现技能还想去送外卖的热爱走路人士", subtitle: nil),
        AchievementTier(category: .steps, threshold: 100_000, title: "您真是白脚起家呀！", subtitle: nil),
        AchievementTier(category: .steps, threshold: 200_000, title: "一人之力托举起9个小动物的奉献之神", subtitle: nil),
        AchievementTier(category: .steps, threshold: 300_000, title: "这地球，这世界，全是您走出来的！", subtitle: nil),
        AchievementTier(category: .steps, threshold: 400_000, title: "不知道您是否听说过一个叫骆驼祥子的人？", subtitle: nil),
        AchievementTier(category: .steps, threshold: 500_000, title: "11路公交车司机", subtitle: nil),
        AchievementTier(category: .steps, threshold: 600_000, title: "你的腿不是腿，是塞纳河畔的春水", subtitle: nil),
        AchievementTier(category: .steps, threshold: 700_000, title: "踏破铁鞋无觅处，蓦然回首，那人却在灯火阑珊处", subtitle: nil),
        AchievementTier(category: .steps, threshold: 800_000, title: "铁板烧！不，是铁脚板！", subtitle: nil),
        AchievementTier(category: .steps, threshold: 1_000_000, title: "宇也球说“我是谁呀，我是您脚底的一颗痣而已”", subtitle: nil)
    ]

    static let postcardTiers: [AchievementTier] = [
        AchievementTier(category: .postcards, threshold: 1, title: "初次相识", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 10, title: "些许相知", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 50, title: "你也有点可爱", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 100, title: "有钱人也不会是无情无义之人", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 200, title: "谁说的有钱人无情无义！", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 300, title: "你说什么都对，My Lord", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 500, title: "很难想象世界上还有你这样完美的人", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 800, title: "我要打包银河系的爱给你", subtitle: nil),
        AchievementTier(category: .postcards, threshold: 1_000, title: "还是打包整个宇宙吧，全是我的真心", subtitle: nil)
    ]
