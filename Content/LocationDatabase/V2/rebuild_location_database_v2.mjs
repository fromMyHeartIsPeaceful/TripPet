...
const coastalCityIds = new Set([
  ...
  "my_melaka", "th_bangkok", "th_phuket", "vn_ho_chi_minh", "vn_da_nang", "id_jakarta", "id_denpasar",
...
const seasideCityIds = new Set([
  ...
  "sg_singapore", "my_penang", "th_phuket", "vn_da_nang", "id_denpasar", "ph_cebu", "mv_male", "in_mumbai",
...
const majorRiverOrLakeCityIds = new Set([
  ...
  "kz_astana", "jp_tokyo", "jp_kyoto", "jp_osaka", "jp_sapporo", "jp_nagoya", "kr_seoul", "kr_daegu", "mn_ulaanbaatar",
...
const metroCityIds = new Set([
  ...
  "kr_seoul", "kr_daegu", "kr_busan", "kr_incheon", "sg_singapore", "my_kuala_lumpur", "th_bangkok",
  "vn_hanoi", "vn_ho_chi_minh", "id_jakarta", "ph_manila", "in_delhi", "in_mumbai",
  "in_kolkata", "in_bengaluru", "in_chennai", "in_jaipur", "ir_tehran", "tr_istanbul", "ae_dubai", "qa_doha",
